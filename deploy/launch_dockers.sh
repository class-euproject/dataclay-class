...
docker run --rm -v $PWD/cfgfiles:/home/dataclayusr/dataclay/cfgfiles -v $PWD/stubs:/stubs --network dataclay_default bscdataclay/client:2.5.dev GetStubs CityUser p4ssw0rd CityNS /stubs
